...
var formControlMixin = Vue.extend({
  props: props$4,
  mounted: function mounted() {
...
var formSelectionMixin = Vue.extend({
  computed: {
    selectionStart: {
...
var formValidityMixin = Vue.extend({
  computed: {
    validity: {
...
var __vue_render__ = function () {
  ...
  return _c('div', {
    ...
    staticClass: "vx-col sm:w-1/2 md:w-1/2 lg:w-3/4 xl:w-3/5 sm:m-0 absolute"
  }, [_c('b-card', {
